...
proc create_root_design { parentCell } {
  ...
  # Create instance: axi_stream_convolver_1, and set properties
  set axi_stream_convolver_1 [ create_bd_cell -type ip -vlnv xilinx.com:user:axi_stream_convolver:1.0 axi_stream_convolver_1 ]
  ...
  connect_bd_net -net axi_stream_convolver_1_m0_axis_data [get_bd_pins axi_stream_convolver_1/m0_axis_data] [get_bd_pins microblaze_0/S0_AXIS_TDATA]
  connect_bd_net -net axi_stream_convolver_1_m0_axis_valid [get_bd_pins axi_stream_convolver_1/m0_axis_valid] [get_bd_pins microblaze_0/S0_AXIS_TVALID]
  connect_bd_net -net axi_stream_convolver_1_m1_axis_data [get_bd_pins axi_stream_convolver_1/m1_axis_data] [get_bd_pins microblaze_0/S1_AXIS_TDATA]
  connect_bd_net -net axi_stream_convolver_1_m1_axis_valid [get_bd_pins axi_stream_convolver_1/m1_axis_valid] [get_bd_pins microblaze_0/S1_AXIS_TVALID]
  connect_bd_net -net axi_stream_convolver_1_s0_axis_ready [get_bd_pins axi_stream_convolver_1/s0_axis_ready] [get_bd_pins microblaze_0/M0_AXIS_TREADY]
  connect_bd_net -net axi_stream_convolver_1_s1_axis_ready [get_bd_pins axi_stream_convolver_1/s1_axis_ready] [get_bd_pins microblaze_0/M1_AXIS_TREADY]
  ...
  connect_bd_net -net clk_wiz_0_clk_out166 [get_bd_pins clk_wiz_0/clk_out166] [get_bd_pins mig_7series_0/sys_clk_i] [get_bd_pins axi_stream_convolver_1/axi_clk]
  ...
  connect_bd_net -net microblaze_0_M0_AXIS_TDATA [get_bd_pins microblaze_0/M0_AXIS_TDATA] [get_bd_pins axi_stream_convolver_1/s0_axis_data]
  connect_bd_net -net microblaze_0_M0_AXIS_TVALID [get_bd_pins microblaze_0/M0_AXIS_TVALID] [get_bd_pins axi_stream_convolver_1/s0_axis_valid]
  connect_bd_net -net microblaze_0_M1_AXIS_TDATA [get_bd_pins microblaze_0/M1_AXIS_TDATA] [get_bd_pins axi_stream_convolver_1/s1_axis_data]
  connect_bd_net -net microblaze_0_M1_AXIS_TVALID [get_bd_pins microblaze_0/M1_AXIS_TVALID] [get_bd_pins axi_stream_convolver_1/s1_axis_valid]
  connect_bd_net -net microblaze_0_S0_AXIS_TREADY [get_bd_pins microblaze_0/S0_AXIS_TREADY] [get_bd_pins axi_stream_convolver_1/m0_axis_ready]
  connect_bd_net -net microblaze_0_S1_AXIS_TREADY [get_bd_pins microblaze_0/S1_AXIS_TREADY] [get_bd_pins axi_stream_convolver_1/m1_axis_ready]
  ...
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins util_vector_logic_0/Res] [get_bd_pins axi_stream_convolver_1/axi_reset_n]
