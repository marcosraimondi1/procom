...
proc create_root_design { parentCell } {
  ...
  set_property CONFIG.IMAGE_HEIGHT {200} $axi_stream_convolver_0
  ...
  connect_bd_net -net axi_stream_convolver_0_m_axis_data [get_bd_pins axi_stream_convolver_0/m_axis_data] [get_bd_pins microblaze_0/S0_AXIS_TDATA]
  connect_bd_net -net axi_stream_convolver_0_m_axis_valid [get_bd_pins axi_stream_convolver_0/m_axis_valid] [get_bd_pins microblaze_0/S0_AXIS_TVALID]
  connect_bd_net -net axi_stream_convolver_0_s_axis_ready [get_bd_pins axi_stream_convolver_0/s_axis_ready] [get_bd_pins microblaze_0/M0_AXIS_TREADY]
  ...
  connect_bd_net -net microblaze_0_M0_AXIS_TDATA [get_bd_pins microblaze_0/M0_AXIS_TDATA] [get_bd_pins ila_0/probe5] [get_bd_pins axi_stream_convolver_0/s_axis_data]
  connect_bd_net -net microblaze_0_M0_AXIS_TVALID [get_bd_pins microblaze_0/M0_AXIS_TVALID] [get_bd_pins axi_stream_convolver_0/s_axis_valid]
  connect_bd_net -net microblaze_0_S0_AXIS_TREADY [get_bd_pins microblaze_0/S0_AXIS_TREADY] [get_bd_pins ila_0/probe7] [get_bd_pins axi_stream_convolver_0/m_axis_ready]
